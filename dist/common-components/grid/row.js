...
let Row = class Row extends React.Component {
    ...
    getGutter() {
        ...
        if (typeof gutter === "object") {
            for (let i = 0; i <= responsiveArray.length; i++) {
                ...
                if (this.state.screens[breakpoint] &&
    ...
    render() {
        const _a = this.props, { type, justify, align, className, style, children, prefixCls = "ant-row" } = _a, others = tslib_1.__rest(_a, ["type", "justify", "align", "className", "style", "children", "prefixCls"]);
