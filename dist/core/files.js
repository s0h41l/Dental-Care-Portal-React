...
function arrayBufferToBase64(buffer, ext) {
    ...
    save(blob, ext, dir) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const path = `/${dir}/${new Date().getTime()}-${generateID(4)}.${ext}`
                    .split("//")
                    .join("/");
                xhr.onload = function () {
                    if (xhr.status === 200) {
                ...
                xhr.onload = function () {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () {
                        if (xhr.status === 200) {
                            ...
                            const base64 = yield arrayBufferToBase64(xhr.response, ext);
                            resolve(base64);
                        }
                        else {
    ...
    status() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                xhr.open("POST", "https://api.dropboxapi.com/2/users/get_current_account");
                xhr.setRequestHeader("Authorization", "Bearer " + accessToken);
                xhr.send();
            });
        });
