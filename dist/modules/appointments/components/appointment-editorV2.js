...
let AppointmentEditorPanelV2 = class AppointmentEditorPanelV2 extends React.Component {
    constructor() {
        super(...arguments);
        this.timerInputs = [];
        this.timeComb = {
                    ...
                    React.createElement(Row, { gutter: 12 },
                        ...
                        React.createElement(Col, { sm: 24 },
                            React.createElement("div", { className: "appointment-input involved-teeth" },
                                React.createElement(TextField, { label: text("Procedure"), disabled: true, value: this.props.procedure.name }))),
                        React.createElement(Col, { span: 24 },
                            " ",
                            React.createElement("div", { className: "appointment-input involved-teeth" },
                                React.createElement(TagInputComponent, { disabled: !this.canEdit, placeholder: text("Involved teeth"), value: this.props.appointment.involvedTeeth.length &&
                                        this.props.appointment.involvedTeeth.map(x => ({
                                            key: x.toString(),
                                            text: x.toString()
                                        })) || this.props.procedure.tooth.map(x => ({
                                        key: x.toString(),
                                        text: x.toString()
                            ...
                            React.createElement("div", { className: "appointment-input paid" },
                                React.createElement(Row, { gutter: 12 },
                                    React.createElement(Col, { sm: 8 },
                                        React.createElement(TextField, { type: "number", disabled: !this.canEdit, label: text("Price"), value: this.props.procedure.fees.toString() || this.props.appointment.finalPrice.toString(), onChange: (e, newVal) => {
                    ...
                    React.createElement(Row, { gutter: 12 },
                        React.createElement(Col, { sm: 24 },
                            React.createElement(Dropdown, { label: text("Status"), options: [
                                    ...
                                    key: x.toString(),
                                    text: x.toString()
                                })), selectedKey: this.props.procedure ? this.props.procedure.status : "", onChange: (ev, val) => {
...
tslib_1.__decorate([
    computed
], AppointmentEditorPanelV2.prototype, "patient", null);
tslib_1.__decorate([
    computed
], AppointmentEditorPanelV2.prototype, "patientInsurance", null);
tslib_1.__decorate([
    observable
], AppointmentEditorPanelV2.prototype, "timerInputs", void 0);
tslib_1.__decorate([
    observable
], AppointmentEditorPanelV2.prototype, "timeComb", void 0);
tslib_1.__decorate([
    computed
], AppointmentEditorPanelV2.prototype, "calcTime", null);
tslib_1.__decorate([
    computed
], AppointmentEditorPanelV2.prototype, "otherAppointmentsNumber", null);
tslib_1.__decorate([
    computed
], AppointmentEditorPanelV2.prototype, "treatmentOptions", null);
tslib_1.__decorate([
    computed
], AppointmentEditorPanelV2.prototype, "canEdit", null);
AppointmentEditorPanelV2 = tslib_1.__decorate([
    observer
], AppointmentEditorPanelV2);
export { AppointmentEditorPanelV2 };
//# sourceMappingURL=appointment-editorV2.js.map