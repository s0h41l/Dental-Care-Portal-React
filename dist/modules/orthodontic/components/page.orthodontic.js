...
import { genderToString, OrthoCase, orthoCases, Patient, PatientAppointmentsPanel, patients, setting } from "@modules";
...
let OrthoPage = class OrthoPage extends React.Component {
    constructor() {
        super(...arguments);
    ...
    get selectedCase() {
        return orthoCases.list.find(orthoCase => orthoCase._id === this.selectedId);
    }
    get selectedPatient() {
    ...
    render() {
        return (React.createElement("div", { className: "orthodontic-cases-component p-15 p-l-10 p-r-10" },
                        ...
                        cells: [
                            {
                                ...
                                component: (React.createElement("div", null,
                                    ...
                                    React.createElement(TooltipHost, { content: text("Orthodontic Case Sheet") },
                                        React.createElement(IconButton, { className: "action-button", iconProps: {
                                    ...
                                    React.createElement(TooltipHost, { content: text("Delete") },
                                        React.createElement(IconButton, { className: "action-button delete", iconProps: {
                                                iconName: "Trash"
                                            }, onClick: () => orthoCases.deleteModal(orthoCase._id), disabled: !this.canEdit })))),
                                className: "no-label"
                            },
                            {
            ...
            React.createElement(Panel, { isOpen: this.showAdditionPanel, type: PanelType.smallFixedFar, closeButtonAriaLabel: "Close", isLightDismiss: true, onDismiss: () => {
                ...
                React.createElement("br", null),
                React.createElement(TagInputComponent, { strict: true, value: [], options: orthoCases.patientsWithNoOrtho.map(patient => ({
                        key: patient._id,
                        text: patient.name
                    })), onAdd: val => {
                        this.showAdditionPanel = false;
                ...
                React.createElement("div", null, this.selectedCase && this.selectedPatient ? (React.createElement("div", { className: "ortho-single-component" },
                    ...
                    this.viewWhich === 2 && (React.createElement("div", null,
                        React.createElement("div", { style: { width: '100%' } },
                            React.createElement("div", { style: { width: '65%', padding: '8px', marginLeft: 'auto' } },
...
OrthoPage = tslib_1.__decorate([
    observer
], OrthoPage);
export { OrthoPage };
//# sourceMappingURL=page.orthodontic.js.map