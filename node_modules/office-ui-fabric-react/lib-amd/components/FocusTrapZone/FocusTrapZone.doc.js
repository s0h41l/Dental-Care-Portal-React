define(["require", "exports", "react", "./examples/FocusTrapZone.Box.Example", "./examples/FocusTrapZone.Box.FocusOnCustomElement.Example", "./examples/FocusTrapZone.Box.Click.Example", "./examples/FocusTrapZone.Nested.Example", "./examples/FocusTrapZone.NoTabbable.Example", "./examples/FocusTrapZone.FocusZone.Example", "./examples/FocusTrapZone.DialogInPanel.Example"], function (require, exports, React, FocusTrapZone_Box_Example_1, FocusTrapZone_Box_FocusOnCustomElement_Example_1, FocusTrapZone_Box_Click_Example_1, FocusTrapZone_Nested_Example_1, FocusTrapZone_NoTabbable_Example_1, FocusTrapZone_FocusZone_Example_1, FocusTrapZone_DialogInPanel_Example_1) {
    "use strict";
    ...
    var FocusTrapZoneNoTabbableExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/FocusTrapZone/examples/FocusTrapZone.NoTabbable.Example.tsx');
    var FocusTrapZoneFocusZoneeExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/FocusTrapZone/examples/FocusTrapZone.FocusZone.Example.tsx');
    ...
    exports.FocusTrapZonePageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                view: React.createElement(FocusTrapZone_FocusZone_Example_1.default, null)
            },
            {
                title: 'FocusTrapZone with No Tabbable Elements',
                code: FocusTrapZoneNoTabbableExampleCode,
                view: React.createElement(FocusTrapZone_NoTabbable_Example_1.default, null)
            },
            {
