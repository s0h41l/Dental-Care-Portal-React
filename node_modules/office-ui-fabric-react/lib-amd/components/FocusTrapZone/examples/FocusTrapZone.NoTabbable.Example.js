define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/FocusTrapZone", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/Toggle", "./FocusTrapZone.Box.Example.scss"], function (require, exports, tslib_1, React, Button_1, FocusTrapZone_1, TextField_1, Toggle_1) {
    "use strict";
    ...
    var BoxExample = /** @class */ (function (_super) {
        ...
        BoxExample.prototype._internalContents = function () {
            ...
            return (React.createElement("div", { className: "ms-FocusTrapZoneBoxExample" },
                React.createElement(TextField_1.TextField, { placeholder: "Not tabbable", className: "", tabIndex: -1 }),
                React.createElement(TextField_1.TextField, { placeholder: "Not tabbable", className: "", tabIndex: -1 }),
                React.createElement(TextField_1.TextField, { placeholder: "Not tabbable", className: "", tabIndex: -1 }),
                React.createElement(Toggle_1.Toggle, { componentRef: this._setRef, checked: isChecked, onChange: this._onFocusTrapZoneToggleChanged, label: "Focus Trap Zone", onText: "On", offText: "Off", tabIndex: -1 }),
                (function () {
                    if (isChecked) {
                        return (React.createElement(Button_1.DefaultButton, { secondaryText: "Exit Focus Trap Zone", onClick: _this._onExitButtonClickHandler, text: "Exit Focus Trap Zone", tabIndex: -1 }));
                    }
                })()));
        };
        return BoxExample;
...
//# sourceMappingURL=FocusTrapZone.NoTabbable.Example.js.map