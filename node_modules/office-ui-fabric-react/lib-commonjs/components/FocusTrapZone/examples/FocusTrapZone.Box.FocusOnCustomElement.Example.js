...
var BoxExample = /** @class */ (function (_super) {
    ...
    function BoxExample(props) {
        ...
        _this.focusClassName = 'shouldFocusInput';
    ...
    BoxExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            (function () {
                if (isChecked) {
                    return React.createElement(FocusTrapZone_1.FocusTrapZone, { firstFocusableSelector: _this.focusClassName }, _this._internalContents());
                }
                else {
    ...
    BoxExample.prototype._internalContents = function () {
        ...
        return (React.createElement("div", { className: "ms-FocusTrapZoneBoxExample" },
            ...
            (function () {
                if (isChecked) {
                    return (React.createElement(Button_1.DefaultButton, { className: _this.focusClassName, secondaryText: "Exit Focus Trap Zone", onClick: _this._onExitButtonClickHandler, text: "Exit Focus Trap Zone" }));
                }
            })()));
    };
    return BoxExample;
