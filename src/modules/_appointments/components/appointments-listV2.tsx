...
import { Appointment, appointments, AppointmentThumbComponent, Procedures } from "@modules";
...
export class AppointmentsListV2 extends React.Component<
	{ list: Appointment[], procedure: Procedures },
	{}
> {
			...
			<div className="appointments-list">
				...
				{appointments.list[
					...
					<AsyncComponent
						key="ae"
						loader={async () => {
							const AppointmentEditorPanel = (await import("./appointment-editorV2"))
