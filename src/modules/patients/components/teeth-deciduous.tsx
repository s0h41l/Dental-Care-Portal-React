...
> {
	render() {
		...
		let diag55;
		if(this.props.teeth[55].diagnosis_key){
			diag55 =  <React.Fragment> <rect x='4300' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='4300' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[55].diagnosis_key}</text></React.Fragment> 
		}

		let diag54;
		if(this.props.teeth[54].diagnosis_key){
			diag54 =  <React.Fragment> <rect x='5300' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='5300' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[54].diagnosis_key}</text></React.Fragment> 
		}

		let diag53;
		if(this.props.teeth[53].diagnosis_key){
			diag53 =  <React.Fragment> <rect x='6200' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='6200' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[53].diagnosis_key}</text></React.Fragment> 
		}

		let diag52;
		if(this.props.teeth[52].diagnosis_key){
			diag52 =  <React.Fragment> <rect x='6800' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='6800' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[52].diagnosis_key}</text></React.Fragment> 
		}

		let diag51;
		if(this.props.teeth[51].diagnosis_key){
			diag51 =  <React.Fragment> <rect x='7700' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='7700' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[51].diagnosis_key}</text></React.Fragment> 
		}

		let diag61;
		if(this.props.teeth[61].diagnosis_key){
			diag61 =  <React.Fragment> <rect x='8500' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='8500' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[61].diagnosis_key}</text></React.Fragment> 
		}

		let diag62;
		if(this.props.teeth[62].diagnosis_key){
			diag62 =  <React.Fragment> <rect x='9400' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='9400' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[62].diagnosis_key}</text></React.Fragment> 
		}

		let diag63;
		if(this.props.teeth[63].diagnosis_key){
			diag63 =  <React.Fragment> <rect x='10100' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='10100' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[63].diagnosis_key}</text></React.Fragment> 
		}

		let diag64;
		if(this.props.teeth[64].diagnosis_key){
			diag64 =  <React.Fragment> <rect x='10900' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='10900' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[64].diagnosis_key}</text></React.Fragment> 
		}

		let diag65;
		if(this.props.teeth[65].diagnosis_key){
			diag65 =  <React.Fragment> <rect x='11800' y='3200' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='11800' y='3400' fill='#fff' fontSize='200'>{this.props.teeth[65].diagnosis_key}</text></React.Fragment> 
		}

		let diag85;
		if(this.props.teeth[85].diagnosis_key){
			diag85 =  <React.Fragment> <rect x='4300' y='12000' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='4300' y='12200' fill='#fff' fontSize='200'>{this.props.teeth[85].diagnosis_key}</text></React.Fragment> 
		}

		let diag84;
		if(this.props.teeth[84].diagnosis_key){
			diag84 =  <React.Fragment> <rect x='5800' y='12000' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='5800' y='12200' fill='#fff' fontSize='200'>{this.props.teeth[84].diagnosis_key}</text></React.Fragment> 
		}

		let diag83;
		if(this.props.teeth[83].diagnosis_key){
			diag83 =  <React.Fragment> <rect x='6600' y='12000' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='6600' y='12200' fill='#fff' fontSize='200'>{this.props.teeth[83].diagnosis_key}</text></React.Fragment> 
		}

		let diag82;
		if(this.props.teeth[82].diagnosis_key){
			diag82 =  <React.Fragment> <rect x='7200' y='12000' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='7200' y='12200' fill='#fff' fontSize='200'>{this.props.teeth[82].diagnosis_key}</text></React.Fragment> 
		}

		let diag81;
		if(this.props.teeth[81].diagnosis_key){
			diag81 =  <React.Fragment> <rect x='7800' y='12000' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='7800' y='12200' fill='#fff' fontSize='200'>{this.props.teeth[81].diagnosis_key}</text></React.Fragment> 
		}

		
		let diag71;
		if(this.props.teeth[71].diagnosis_key){
			diag71 =  <React.Fragment> <rect x='8500' y='12400' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='8500' y='12600' fill='#fff' fontSize='200'>{this.props.teeth[71].diagnosis_key}</text></React.Fragment> 
		}

		let diag72;
		if(this.props.teeth[72].diagnosis_key){
			diag72 =  <React.Fragment> <rect x='9100' y='12400' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='9100' y='12600' fill='#fff' fontSize='200'>{this.props.teeth[72].diagnosis_key}</text></React.Fragment> 
		}

		let diag73;
		if(this.props.teeth[73].diagnosis_key){
			diag73 =  <React.Fragment> <rect x='9700' y='12400' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='9700' y='12600' fill='#fff' fontSize='200'>{this.props.teeth[73].diagnosis_key}</text></React.Fragment> 
		}

		let diag74;
		if(this.props.teeth[74].diagnosis_key){
			diag74 =  <React.Fragment> <rect x='10500' y='12400' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='10500' y='12600' fill='#fff' fontSize='200'>{this.props.teeth[74].diagnosis_key}</text></React.Fragment> 
		}

		let diag75;
		if(this.props.teeth[75].diagnosis_key){
			diag75 =  <React.Fragment> <rect x='11900' y='12400' fill="red" width="550" height="200" style={{ stroke: 'red', strokeWidth: 25, opacity: 1}}> </rect> <text  x='11900' y='12600' fill='#fff' fontSize='200'>{this.props.teeth[75].diagnosis_key}</text></React.Fragment> 
		}
...
<svg
    ...
    >
      ...
      ></path>
			...
			<text fill='#333333' x='4300' y='3800' style={{fontSize: 250}}>A</text>
			{diag55}
			...
			<text fill='#333333' x='8500' y='4200' style={{fontSize: 250}}>F</text>
			{diag61}
			<text fill='#333333' x='9400' y='4100' style={{fontSize: 250}}>G</text>
			{diag62}
